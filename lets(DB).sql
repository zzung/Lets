...
CREATE TABLE "MEM_PAY" (
	...
	"PAY_STATUS"       VARCHAR2(2)      DEFAULT 'Y'  NOT NULL,
	"DEL_POSTCODE"   VARCHAR2(20) NULL,
	"DEL_POST_ADR"	VARCHAR2(200) NULL,
	"DEL_DETAIL_ADR"	VARCHAR2(200) NULL,
	"DEL_EXTRA_ADR"	VARCHAR2(100) NULL,
...
COMMENT ON COLUMN "MEM_PAY"."PAY_STATUS" IS '결제상태'

COMMENT ON COLUMN "MEM_PAY"."DEL_POSTCODE" IS '배송 우편번호';

COMMENT ON COLUMN "MEM_PAY"."DEL_POST_ADR" IS '배송 도로명 주소';

COMMENT ON COLUMN "MEM_PAY"."DEL_DETAIL_ADR" IS '배송 상세주소';

COMMENT ON COLUMN "MEM_PAY"."DEL_EXTRA_ADR" IS '배송 참고주소';
...
CREATE SEQUENCE SEQ_QNANO NOCACHE;
