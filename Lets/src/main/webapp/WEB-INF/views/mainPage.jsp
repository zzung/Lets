...
<body>
	<!--메뉴바  -->
	<jsp:include page="../views/user/common/navBar.jsp" />
    ...
    <!-- Kids Popular Course End -->
        ...
        <!--? Count Down Start -->
        <div class="count-down-area pt-90 pb-60 section-bg" data-background="resources/user/assets/img/gallery/section_bg01.png">
            <div class="container">
                <div class="row justify-content-center">
