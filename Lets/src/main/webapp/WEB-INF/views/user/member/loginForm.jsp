                ...
                <div class="login-content1">
	                <form id="loginForm" action="" method="post">
	                    ...
	                    <div class="login-bottom">
	                        <div class="genric-btn primary radius" onclick="loginSubmit(1);">로그인 하기</div><br>
	                        <div class="genric-btn success radius" onclick="loginSubmit(2);">네이버로 시작하기</div><br>
	                        <div class="genric-btn warning radius" onclick="loginSubmit(3);" style="color: black;">카카오로 시작하기</div>
	                        <br>
