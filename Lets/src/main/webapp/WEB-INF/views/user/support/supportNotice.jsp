		...
		<div style="width:1000px;">
			...
			<div class="blog-pagination justify-content-center d-flex" align="center">
				...
				<c:choose>
					...
					<c:otherwise>
						<li class="page-item">
				            <a href="supportNotice.su?currentPage=${pi.currentPage -1 }" class="page-link" aria-label="Previous">
				                <i class="ti-angle-left"></i>
				            </a>
				        </li>
					</c:otherwise>
						...
						<c:when test="${pi.currentPage ne p }">
							<c:choose>
								...
								<li class="page-item active">
						            <a href="supportNotice.su?currentPage=${p}" class="page-link">${p}</a>
						        </li>
								</c:when>
								<c:otherwise>
				...
				<c:choose>
					...
					<c:otherwise>
						<li class="page-item">
							<a href="supportNotice.su?currentPage=${pi.currentPage +1 }" class="page-link" aria-label="Next">
				                <i class="ti-angle-right"></i>
				            </a>
						</li>
					</c:otherwise>
