	    ...
	    <div class="welcome" align="center">
	        ...
	        <table class="list-area">
	            ...
	            <tr>
	                ...
	                <td><button type="button" data-toggle="modal" data-target="#paymentInquiry" class="btn btn-default">조회</button></td>
	            ...
	            <tr>
	                ...
	                <td><button type="button" data-toggle="modal" data-target="#paymentInquiry" class="btn btn-default">조회</button></td>
	                <td><button onclick="cancelPay();" id="payCancelBtn" class="btn btn-default">결제취소</button></td>
	            </tr>
	        </table>
	         <!--?Modal Start-->
	        ...
	        <script>
	            function cancelPay(){
	                ...
	                var payCondition = document.getElementById("payCondition" + num)
