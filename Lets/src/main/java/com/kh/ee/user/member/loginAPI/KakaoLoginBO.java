package com.kh.ee.user.member.loginAPI;
...
public class KakaoLoginBO {
	...
	private final static String K_CLIENT_ID = "3024797ce5640ad7c79adb3fc070bfb5";
	private final static String K_REDIRECT_URI = "http://localhost:8888/ee/kakaologin.me";
	
	public static String getAuthorizationUrl(HttpSession session) {
		String kakaoUrl = "https://kauth.kakao.com/oauth/authorize?"
						+ "client_id=" + K_CLIENT_ID + "&redirect_uri=" + K_REDIRECT_URI
						+ "&response_type=code";
